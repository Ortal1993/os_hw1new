...
class ChangeDirCommand : public BuiltInCommand {
    private:
        ...
        char** currentPwd;
    public:
        ChangeDirCommand(const char* cmd_line, char** lastPwd = nullptr, char** currentPwd = nullptr);
...
class SmallShell {
    ...
    private:
        ...
        std::string prompt;
        JobsList jobsList;
        SmallShell(): pid(getpid()), lastPwd(nullptr), currentPwd(nullptr), prompt("smash"), jobsList(jobsList){}///getpid is always successful according to man
    public:
